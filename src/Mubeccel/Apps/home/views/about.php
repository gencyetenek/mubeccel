...
<p class="text-right p-0 m-0 text-primary">Selim Can Özdemir</p>
<hr>
<p>
    ...
    ve bugları olabilir, <span class="text-danger">Eleştirileriniz ve tavsiyeleriniz benim için çok değerli</span>. Test edebilmeniz için kullanıma sunuyorum.  
</p>
<p>
    Şimdi aklınızdaki bir soru var,
    <span class="font-weight-bold">"Piyasada onlarca framework varken neden kendin yazma ihtiyacı hissettin ?"</span> 
